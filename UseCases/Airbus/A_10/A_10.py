...
class A_10(Workflow.Workflow):
    ...
    def __init__(self, metaData={}):
        ...
        super(A_10, self).__init__(metaData=MD)
    ...
    def initialize(self, file='', workdir='', targetTime=PQ.PhysicalQuantity(0., 's'), metaData={}, validateMetaData=True, **kwargs):
        ...
        super(A_10, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
