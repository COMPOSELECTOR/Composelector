...
class Airbus_Workflow_8(Workflow.Workflow):
    ...
    def __init__(self, metaData={}):
        ...
        super(Airbus_Workflow_8, self).__init__(metaData=MD)
    ...
    def initialize(self, file='', workdir='', targetTime=PQ.PhysicalQuantity(1., 's'), metaData={}, validateMetaData=True, **kwargs):
        ...
        super(Airbus_Workflow_8, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
    ...
    def terminate(self):
        ...
        super(Airbus_Workflow_8, self).terminate()
