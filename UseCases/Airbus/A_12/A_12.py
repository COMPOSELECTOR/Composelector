...
############################
        ...
        super(A_12, self).__init__(metaData=MD)
        self.updateMetadata(metaData)        

        #list of recognized input porperty IDs
        self.myInputPropIDs = [PropertyID.PID_YoungModulus1 ,
                               PropertyID.PID_YoungModulus2 , 
                               PropertyID.PID_YoungModulus3 , 
                               PropertyID.PID_PoissonRatio12, 
                               PropertyID.PID_PoissonRatio13,
                               PropertyID.PID_PoissonRatio23, 
                               PropertyID.PID_ShearModulus12, 
                               PropertyID.PID_ShearModulus13, 
                               PropertyID.PID_ShearModulus23]     
        # list of compulsory IDs
        self.myCompulsoryPropIDs = self.myInputPropIDs
        #list of recognized output property IDs
        self.myOutPropIDs =  [PropertyID.PID_Volume,PropertyID.PID_Stiffness]
...
# initialisze abaqus application 
        ...
        super(A_12, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
        ...
        app2MD['Inputs']=self.getMetadata('Inputs').copy()
        app2MD['Outputs']=self.getMetadata('Outputs').copy()
