...
class Workflow_1_2_2(Workflow.Workflow):
    ...
    def __init__(self, metaData={}):
        ...
        super(Workflow_1_2_2, self).__init__(metaData=MD)
    ...
    def initialize(self, file='', workdir='', targetTime=PQ.PhysicalQuantity(1., 's'), metaData={}, validateMetaData=True, **kwargs):
        ...
        super(Workflow_1_2_2, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
    ...
    def terminate(self):
        ...
        super(Workflow_1_2_2, self).terminate()
