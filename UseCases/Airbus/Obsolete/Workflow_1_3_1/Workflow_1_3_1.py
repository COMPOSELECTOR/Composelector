...
class Workflow_1_3_1(Workflow.Workflow):
    ...
    def __init__(self, metaData={}):
        ...
        super(Workflow_1_3_1, self).__init__(metaData=MD)
    ...
    def initialize(self, file='', workdir='', targetTime=PQ.PhysicalQuantity(0., 's'), metaData={}, validateMetaData=True, **kwargs):
        ...
        super(Workflow_1_3_1, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
