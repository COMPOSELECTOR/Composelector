...
class Airbus_Workflow_3(Workflow.Workflow):
    ...
    def initialize(self, file='', workdir='', targetTime=PQ.PhysicalQuantity(0., 's'), metaData={}, validateMetaData=True, **kwargs):
        ...
        super(Airbus_Workflow_3, self).initialize(file=file, workdir=workdir, targetTime=targetTime, metaData=metaData, validateMetaData=validateMetaData, **kwargs)
    ...
    def terminate(self):
        ...
        super(Airbus_Workflow_3, self).terminate()
