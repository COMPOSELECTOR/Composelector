...
#                  }
    ...
    try:
        ...
        digimatAppMD['Inputs'] = [
            #{'Type': 'mupif.Property', 'Type_ID': 'mupif.DigimatPropertyID.PID_MatrixOgdenModulus',  'Name': 'Ogden Moduli', 'Units': 'MPa', 'Required': True},
            #{'Type': 'mupif.Property', 'Type_ID': 'mupif.DigimatPropertyID.PID_MatrixOgdenExponent',  'Name': 'Ogden Exponent', 'Units': 'none', 'Required': True},
        ...
        digimatAppMD['Outputs'] = [
            #{'Type': 'mupif.Property', 'Type_ID': 'mupif.DigimatPropertyID.PID_CompositeStress11Tensor',  'Name': 'axial stress vector', 'Units': 'MPa', 'Required': True},
            #{'Type': 'mupif.Property', 'Type_ID': 'mupif.DigimatPropertyID.PID_CompositeStrain11Tensor',  'Name': 'axial strain vector', 'Units': 'none', 'Required': True},
            #{'Type': 'mupif.Property', 'Type_ID': 'mupif.DigimatPropertyID.PID_CompositeStrain22Tensor',  'Name': 'transverse stress vector', 'Units': 'none', 'Required': True},
        ]
        workflow.digimatApp.initialize(metaData=digimatAppMD, validateMetaData = False)
		
        # set hyperelastic properties for DigimatMF
        workflow.digimatApp.setProperty(Property.ConstantProperty(tuple(MatrixOgdenModulus_values), DigimatPropertyID.PID_MatrixOgdenModulus, ValueType.Scalar, "MPa"))
        workflow.digimatApp.setProperty(Property.ConstantProperty(tuple(MatrixOgdenExponent_values), DigimatPropertyID.PID_MatrixOgdenExponent, ValueType.Scalar, "none"))
        ...
        stress = workflow.digimatApp.getProperty(DigimatPropertyID.PID_CompositeStress11Tensor).getValue()
        axistrain =  workflow.digimatApp.getProperty(DigimatPropertyID.PID_CompositeStrain11Tensor).getValue()
        transtrain  = workflow.digimatApp.getProperty(DigimatPropertyID.PID_CompositeStrain22Tensor).getValue()
